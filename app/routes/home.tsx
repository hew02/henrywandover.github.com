    ...
    <div className="content">
      <h1>The Home Page of Henry Wandover</h1>
			...
			<p>
						...
						currently reside in Philadelphia. My interests in computing
						are programming languages and desktop, developer tools. 
						Along with software, I also enjoy writing and video editing. 
						I'm currently job hunting, if you
