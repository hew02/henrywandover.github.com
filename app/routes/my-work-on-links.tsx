...
export default function Links() {
  return (
    <div className="content">
      ...
      <embed src={poster} type="application/pdf" width="100%" height="600px" />
      ...
      <p>
        ...
        additional, shorter, paper detailing more in depth the theory and their
        place in the functional world. When I have time I will update this page
        with more information on subkind classes or further work I commit
        towards the Links project.
      </p>
    </div>
  );
}
