...
<ol class="bullet">
    <li><p>Mainly for my personal usage, <a href="https://yung-turabian.github.io/xtralib/"
                                       target="_blank" rel="noreferrer noopener"
                                       title="View Doxygen pages for my lib">
        xtralib</a>, is a extension for C/C++ programming. The link takes you to its Doxygen pages. </p></li>
    <li><p>Starting in a programming languages class, <a href="https://github.com/yung-turabian/hasktan/"
                                                         target="_blank"
                                                         rel="noreferrer noopener"
                                                         title="Git repository">
        hasktan</a>, was the culmination of that class's work. However, I still tinker with it.</p></li>
    <li>
        <p>
            <a
        ...
        title="Game">Turbulent Trader</a>
            is a game orginating from a game jam, one of my first game projects that is playable!
        </p>
    </li>
</ol>
