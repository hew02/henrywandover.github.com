...
<div class="content">
  <h2>Henry Wandover</h2>
	...
	If you have an opportunity, or know of one, check out my <a href="/Resume.pdf" hreflang="en" target="_blank" rel="noreferrer noopener" type="application/pdf">résumé</a>
	and the rest of my site.
	</p>

	<p>
		The ideal way of getting in contact is by email: <a aria-label="Social media link" href="mailto:henrywandover@gmail.com" rel="noopener noreferrer" title="Email">henrywandover [at] gmail.com</a>.
